...
require_once LDD_ORDERING_DIR_LIB . 'aihrus-framework/class-aihrus-widget.php';

if ( class_exists( 'LDD_Ordering_Widget' ) )
	return;


class LDD_Ordering_Widget extends Aihrus_Widget {
	const ID = 'ldd-ordering-widget';

	public function __construct( $classname = null, $description = null, $id_base = null, $title = null ) {
		$classname   = 'LDD_Ordering_Widget';
		$description = esc_html__( 'Display Legal Document Deliveries - Ordering entries.' );
		$id_base     = self::ID;
		$title       = esc_html__( 'Legal Document Deliveries - Ordering' );
	...
	public static function get_defaults() {
		return LDD_Ordering::get_defaults();
	}
	...
	public static function validate_settings( $instance ) {
		return LDD_Ordering_Settings::validate_settings( $instance );
	}
	...
	public static function form_parts( $instance, $number ) {
		$form_parts = LDD_Ordering_Settings::get_settings();
	...
	public static function widget_options( $options ) {
		...
		$options = apply_filters( 'ldd_ordering_widget_options', $options );
